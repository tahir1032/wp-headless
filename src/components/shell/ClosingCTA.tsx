...
type ClosingCTAProps = {
  ...
  subtext?: string;
  buttonLabel?: string;
  /** Renders a second "Message on WhatsApp" button next to the primary one. */
  showWhatsAppButton?: boolean;
  /** Renders a small "Or message me on WhatsApp" text link below the primary button instead. */
      ...
      <div className="container-fluid">
        ...
        <div className="flex flex-wrap items-center justify-center gap-3.75">
          ...
          {showWhatsAppButton && (
            <a
              ...
              className="inline-flex items-center gap-2.5 bg-cleangray text-primary py-4 px-6.25 rounded-full group overflow-hidden hover:bg-primary hover:text-white duration-300"
            >
        ...
        {showWhatsAppLink && (
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="inline-flex items-center gap-2 text-sm text-mediumgray mt-5 hover:text-primary duration-300"
          >
            <i className="fa-brands fa-whatsapp"></i>
