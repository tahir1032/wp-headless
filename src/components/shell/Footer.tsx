          ...
          <div className="xl:1/2 w-full 4xl:pl-40 xl:pl-15 lg:pl-10">
            <div className="sm:flex xl:justify-center justify-between 2xl:gap-50 md:gap-30 gap-25 xl:pb-25 pb-15">
              ...
              <div className="max-sm:mb-12">
                ...
                <a href="/developer" className="block text-base text-gray mb-3 relative hover:text-primary duration-500"><span className="link-hover">Developer</span></a>
                <a href="/industries" className="block text-base text-gray mb-3 relative hover:text-primary duration-500"><span className="link-hover">Industries</span></a>
