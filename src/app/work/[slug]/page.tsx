export function generateStaticParams() {
  return [{ slug: "ecommerce-conversion-boost" }];
}
        ...
        <div className="grid grid-cols-12 gap-5 pb-10">
          <div className="xl:col-span-4 col-span-12">
            <div className="my-sticky">
              <h2 className="4xl:text-5xl 2xl:text-4xxxl md:text-4xl text-3xl font-semibold">Ecommerce Conversion Boost</h2>
              <div className="flex items-center gap-2.5 max-xl:py-5">
                <span className="sm:text-base text-sm text-mediumgray">03 Jan 2026</span>
                <p className="sm:text-base text-sm text-primary"><span className="text-base text-mediumgray">Client Name:</span> NovaTech Solutions</p>
              </div>
              <div className="flex items-center sm:gap-2.5 gap-1.25 xl:mt-12.5 max-xl:pb-5">
                {["Meta Ads", "Google Ads", "CRO", "Analytics"].map((tag) => (
          ...
          <div className="xl:col-span-8 col-span-12">
            <div className="grid grid-cols-12 gap-5">
              <div className="col-span-12 dz-hover-item">
                <a className="dz-hover-img rounded-2lg relative size-full" data-displacement="/images/work/6.webp" data-intensity="0.6" data-speedin="1" data-speedout="1">
                  <img src="/images/work/1.webp" className="w-full rounded-sm" alt="img" loading="lazy" />
                </a>
              </div>
              <div className="md:col-span-7 col-span-12 dz-hover-item">
                <a className="dz-hover-img rounded-2lg relative size-full" data-displacement="/images/work/6.webp" data-intensity="0.6" data-speedin="1" data-speedout="1">
                  <img src="/images/work/2.webp" className="w-full rounded-sm" alt="img" loading="lazy" />
                </a>
              </div>
              <div className="md:col-span-5 col-span-12">
                <div className="rounded-sm bg-shadegray 2xl:py-12.5 2xl:px-10 p-5 h-full">
                  ...
                  <p className="4xl:text-2xl text-xl font-light text-softgray">
              ...
              <div className="md:col-span-6 col-span-12 dz-hover-item">
                <a className="dz-hover-img rounded-2lg relative size-full" data-displacement="/images/work/6.webp" data-intensity="0.6" data-speedin="1" data-speedout="1">
                  <img src="/images/work/3.webp" className="w-full rounded-sm" alt="img" loading="lazy" />
                </a>
              </div>
              <div className="md:col-span-6 col-span-12 dz-hover-item">
                <a className="dz-hover-img rounded-2lg relative size-full" data-displacement="/images/work/6.webp" data-intensity="0.6" data-speedin="1" data-speedout="1">
                  <img src="/images/work/4.webp" className="w-full rounded-sm" alt="img" loading="lazy" />
                </a>
              </div>
              ...
              <div className="lg:col-span-7 col-span-12 dz-hover-item">
                <a className="dz-hover-img rounded-2lg relative size-full" data-displacement="/images/work/6.webp" data-intensity="0.6" data-speedin="1" data-speedout="1">
                  <img src="/images/work/5.webp" className="w-full rounded-sm" alt="img" loading="lazy" />
                </a>
              </div>
              <div className="md:col-span-7 col-span-12">
                <div className="flex items-center justify-center gap-5 2xl:py-47.5 py-20">
                  <div className="group relative">
                    <a href="/work" className="xl:size-50 lg:size-40 size-30 bg-minimalgray/[0.96] rounded-full flex items-center justify-center duration-500 group-hover:bg-primary/[0.96] group/second overflow-hidden">
